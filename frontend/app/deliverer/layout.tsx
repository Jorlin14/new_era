/**
 * Deliverer Layout - New Era Supermercado
 * 
 * Layout principal del dashboard de domiciliarios.
 * Incluye protección de rutas y navegación específica para repartidores.
 * 
 * Características:
 * - Sidebar con navegación para domiciliarios
 * - Protección de rutas (solo DELIVERER)
 * - Información del usuario autenticado
 * - Logout funcional
 * 
 * @module app/deliverer/layout
 */
...
import ProtectedRouteDeliverer from '@/components/deliverer/ProtectedRouteDeliverer';
              ...
              <div className="flex items-center gap-3">
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <p className="text-xs text-slate-400 truncate">
                    {user?.email || 'domiciliario@newera.com'}
                  </p>
                </div>
              </div>
              <Link
